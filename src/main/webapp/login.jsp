                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <%
    							...
    							<li class="nav-item d_none">
                                    <a class="nav-link" href="acesso-restrito.jsp">Acesso Restrito</a>
                                 </li>
    							<% } else {%>
                               <li class="nav-item d_none">
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-md-10 offset-md-1">
                  <form id="request" Method="POST" action="LoginCliente" class="main_form">
                     <div class="row">
                        <div class="col-md-12 ">
                        ...
                        <a href="cadastro.jsp" class="send_btn btn">Cadastrar</a>
                         </div>
                  </form>
               </div>
            </div>
