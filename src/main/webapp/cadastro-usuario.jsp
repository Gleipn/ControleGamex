        ...
        <div class="card-body row">
          <div class="col-5 text-center d-flex align-items-center justify-content-center">
            <div class="">
              ...
              <p class="lead mb-5">Cadastre um usuario</p>
              	<%
          ...
          <div class="col-7">
            <form action="CadastrarUsuario" method="post">
              <div class="form-group">
                ...
                <input type="password" id="idNome" name="inputSenha" class="form-control" />
                <label for="idNome">Repita sua senha</label>
                <input type="password" id="idNome" name="inputSenhaRepetida" class="form-control" />
              </div>
              <div class="form-group">
