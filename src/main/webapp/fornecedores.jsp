      ...
      <div class="card card-solid">
        <div class="card-body pb-0">
          <div class="text-right">
            <a href="cadastro-fornecedor.jsp" class="btn btn-link">
            ...
            <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
              <div class="card bg-light d-flex flex-fill">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                      <h2 class="lead"><%= f.getNome() %></h2>
                      <p class="text-muted text-sm"><b>Criado em: </b> <%= f.getCriado_em() %> </p>
                ...
                <div class="card-footer">
                  <div class="text-right">
                    <a href="IniciarAlterarFornecedor?id=<%= f.getId() %>" class="btn btn-sm btn-primary">
                      <i class="fas fa-boxes-stacked"></i> Editar
                    </a>
                    <a href="ExcluirFornecedor?id=<%= f.getId() %>" class="btn btn-sm btn-danger"
